def main():
    ...
    num_cpu = 16
    lr = '6.288e-05'
    wandb_name = f"puffinCaller_classify_onlyFunctional_8_balanced_labels-{lr}-mxepch24"
    num_labels = 8
    max_epch = 24
    gpus = '4, 5'

    data_folder = "tensor_datasets"
    strat_train_name = "onlyFunctional_balanced_8_strat_train.pt"
    strat_val_name = "onlyFunctional_balanced_8_strat_val.pt"

    model_folder = "onlyFunctional/ckpt"
    save_checkpoint_name = "onlyFunctional_balanced_8_labels_maxepch24.ckpt"
    ...
    checkpoint_callback = ModelCheckpoint(
        ...
        filename='onlyFunctional_balanced_8_labels_best_loss',
        save_top_k=3,
        mode='min'
    )
